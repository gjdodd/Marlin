...
//
  ...
  #define COOLER_PIN               PIN_P2_11 // default = 8  // Laser cooler on/off pin used to control power to the cooling element e.g. TEC, External chiller via relay
  #define COOLER_INVERTING     false
  #define TEMP_COOLER_PIN          P0_23_A0 // default = 15  // Laser/Cooler temperature sensor pin. ADC is required.
...
#define LASER_COOLANT_FLOW_METER
  ...
  #define FLOWMETER_PIN         P2_12 // default = 20  // Requires an external interrupt-enabled pin (e.g., RAMPS 2,3,18,19,20,21)
  #define FLOWMETER_PPL       450 //5880 // default = 5880  // (pulses/liter) input pin
...
//#define Z_STEPPER_AUTO_ALIGN
  ...
  //#define Z_STEPPER_ALIGN_XY { {  10, 145 }, { 280,  145 }, { 190, 190 } }
...
#define DIGIPOT_MCP4451
  ...
  #define DIGIPOT_I2C_MOTOR_CURRENTS { 0.6, 0.5, 0.6, 0.6, 1.0 } // AZTEEG_X3_PRO
...
#define LASER_FEATURE
  ...
  #define SPINDLE_LASER_FREQUENCY       4251   //2500   // (Hz) Spindle/laser frequency (only on supported HALs: AVR and LPC)
